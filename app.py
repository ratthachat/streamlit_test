...
#   return Jung_Lingo_init + current_selection + generated_texts + '\n\n#####\n\n' + current_selection
  return Jung_Lingo_init + Jung_Lingo_short_examples + current_selection, current_selection

hidden_prompt, current_prompt_only = get_init_prompt(context_texts, level_option, who_option)
if show_hidden:
...
prompt_text = current_prompt_only
translated_text = translator.translate(prompt_text, lang_tgt=chosen_lang)

xx = 'Hey, hi!'
yy = translator.translate(xx, lang_tgt=chosen_lang)
